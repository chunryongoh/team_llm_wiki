...
이 leaf는 DACON code share `13975`가 보고한 [Public 0.5917 reference](../performance/dacon-public-05917-lgbm-xgb-anchor-reference.md)의 reusable model pattern을 관리한다. Team verified model이 아니라 external reference다.
