...
문형도 packet `2026-05-29-v200-v209-sparse-splice-review`는 DPSleep/SleepMore-inspired morphology, 5분 raw sequence, validator blind spot, Q2/Q3 residual edit, sparse splice guardrail을 정리한다. 이 page의 수치는 [DACON Leaderboard History](../performance/dacon-leaderboard-history.md)에 `user_reported_public_score_only`로만 반영한다.
