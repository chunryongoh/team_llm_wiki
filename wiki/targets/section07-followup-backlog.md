...
| `section07-oq-003` | P1 | evaluation owner | false | public score notes를 verified DACON leaderboard record로 승격할 수 있는가? | submission id, leaderboard export, submission CSV lineage | [DACON Leaderboard History](../performance/dacon-leaderboard-history.md)에 verified entry가 추가된다. |
